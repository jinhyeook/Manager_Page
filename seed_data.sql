...
('킥보드', POINT(126.9523, 37.3693), 85, 0), -- 안양대학교 정문 근처
('킥보드', POINT(126.9505, 37.3688), 45, 0), -- 안양대학교 후문 근처
('킥보드', POINT(126.9531, 37.3705), 15, 1), -- 안양역 근처
('자전거', POINT(126.9510, 37.3712), 92, 0), -- 안양대학교 운동장 근처
('자전거', POINT(126.9498, 37.3675), 73, 1); -- 안양대학교 아리비전센터 근처
